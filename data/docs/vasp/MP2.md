...
* The first step is the determination of the occupied orbitals of the Hartree-Fock Hamiltonian. Note that MP2 requires calculating the Hartree-Fock ground state, and any LDA or GGA correlation should be switched off. Following specific INCAR tags have to be set:
