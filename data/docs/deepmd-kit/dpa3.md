# Descriptor DPA3 [PyTorch] [JAX] [PaddlePaddle] [DP]

**Supported backends**: PyTorch [PyTorch], JAX [JAX], DP [DP]
...
## Requirements of installation from source code [PyTorch] [PaddlePaddle]
...
## Limitations of the JAX backend with LAMMPS [JAX]
