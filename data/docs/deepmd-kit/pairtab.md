# Interpolation or combination with a pairwise potential [TensorFlow] [PyTorch] [DP]

**Supported backends**: TensorFlow [TensorFlow], PyTorch [PyTorch], DP [DP]
...
DeePMD-kit also supports combination with a pairwise potential [TensorFlow]:
...
## Combination with a pairwise potential [TensorFlow]
