# Finetune the pre-trained model [TensorFlow] [PyTorch] [PaddlePaddle]

**Supported backends**: TensorFlow [TensorFlow], PyTorch [PyTorch], Paddle [PaddlePaddle]
...
## Paddle Implementation [PaddlePaddle]
