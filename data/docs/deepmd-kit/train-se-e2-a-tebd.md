# Type embedding approach [TensorFlow] [PyTorch] [JAX] [DP]

**Supported backends**: TensorFlow [TensorFlow], PyTorch [PyTorch], JAX [JAX], DP [DP]
...
## Instructions for TensorFlow backend [TensorFlow]
